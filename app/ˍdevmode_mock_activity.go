...
const mockNumReqsPerSecApprox = 11 // max ~111 for outside-vscode `go run`s, ~33 in vscode dlv debug runs (due to default Postgres container's conn-limits setup)
