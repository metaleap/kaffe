...
const UserUpdateChangesAuth = q.F("Changes.Auth")
const UserUpdateChangesBtw = q.F("Changes.Btw")
const UserUpdateChangesBuddies = q.F("Changes.Buddies")
const UserUpdateChangesDtMade = q.F("Changes.DtMade")
const UserUpdateChangesDtMod = q.F("Changes.DtMod")
const UserUpdateChangesId = q.F("Changes.Id")
const UserUpdateChangesLastSeen = q.F("Changes.LastSeen")
const UserUpdateChangesNick = q.F("Changes.Nick")
const UserUpdateChangesPicFileId = q.F("Changes.PicFileId")
